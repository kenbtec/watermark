! function(t, e, i) {
    ...
    var n = "watermark",
        r = { path: "watermark.png", text: "", textWidth: 130, textSize: 13, textColor: "white", textBg: "rgba(0, 0, 0, 0.4)", gravity: "se", opacity: 10, margin: 10, outputWidth: "50%", outputHeight: "auto", outputType: "jpeg", done: function(t) { this.src = t }, fail: function() {}, always: function() {} };
